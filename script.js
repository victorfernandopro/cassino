...
const sortear = () => {
    if (creditos > 0) {
        if (numeroEscolhido !== null) {
            ...
            resultado.innerText = 'Selecione um número';
            setTimeout(() => {
                resultado.innerText = 'Escolha um número e clique em Sortear para começar';
            }, 1200)
        }
    } else {
        resultado.innerText = 'Insira créditos para começar';
        setTimeout(() => {
            resultado.innerText = 'Insira créditos, escolha um número e clique em Sortear para começar';
        }, 1200)
    }
}
